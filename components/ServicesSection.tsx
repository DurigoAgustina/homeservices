  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-8 relative">
          ...
          {/* Card amarillo */}
          <div className="absolute flex flex-col items-center gap-4 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#FFC527] text-black rounded-3xl w-[150px] py-8 shadow-lg max-w-xs text-center font-bold z-10">
            <div>
        ...
        <div className="text-black">
          ...
          <p className="text-gray-600 mb-8">
            Imperdiet massa tincidunt nunc pulvinar sapien. Sit amet facilisis magna etiam odio mollis.
            Entero lacus ligula, imperdiet vel massa in, maximus suscipit turpis.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 flex items-center justify-center bg-gray-100 rounded-full">
                <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m2 8H7a2 2 0 01-2-2V6a2 2 0 012-2h8l6 6v8a2 2 0 01-2 2z"/>
                </svg>
              </div>
              <div>
                <h4 className="text-lg font-semibold">Solución Personalizada</h4>
                <p className="text-gray-600">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Quien o eros hasta y odian el tiempo. Praesent semper feugiat nibh sed pulvinar.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 flex items-center justify-center bg-gray-100 rounded-full">
                <svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8 16h8M8 12h8m-6 8h6M6 4h12v16H6V4z"/>
                </svg>
              </div>
              <div>
                <h4 className="text-lg font-semibold">Servicio Todo En Uno</h4>
                <p className="text-gray-600">
                  Pellentesque id nibh tortor id. Quis vel eros donec ac odio facilisi nullam.
                </p>
              </div>
            </div>
          </div>
